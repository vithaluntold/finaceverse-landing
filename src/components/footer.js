          ...
          <div className="footer-bento-grid">
            <div className="footer-bento-cell footer-brand-cell">
              ...
              <div className="footer-social-links">
                ...
                <a href="https://x.com/finACE_group" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)">
                  <div className="footer-social-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                ...
                <a href="https://www.facebook.com/finacegroup.io" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                  <div className="footer-social-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                ...
                <a href="https://www.instagram.com/finace_group/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                  <div className="footer-social-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                      <g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
                ...
                <a href="https://www.youtube.com/@FinACEverse" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
                  <div className="footer-social-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                      <g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
                ...
                <a href="https://wa.me/message/CLGWPGDW4XFOJ1" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
                  <div className="footer-social-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
